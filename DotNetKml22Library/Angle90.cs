...
{
	/// <summary>
	/// An angle value ≥−90 and ≤90.
	/// </summary>
	public struct Angle90
	{
		const double minimumValue = -90;
		const double maximumValue = 90;
		double _value;

		/// <summary>
		/// Initialize a new instance of the <see cref="Angle90"/> struct with
		/// a value of <paramref name="value"/>.
		/// </summary>
		/// <param name="value">The value to assign.</param>
		public Angle90(double value)
		{
